...
/* branch predictor type {nottaken|taken|perfect|bimod|2lev|comb|tsbp|chbp|oht|ob|mbp|tscl|llbp} */
static char *pred_type;

/* bimodal predictor config (<table_size> <frmt>) */
static int bimod_nelt = 2;
static int bimod_config[2] =
  { /* bimod tbl size */2048, /* frmt */FALSE };

/* 2-level predictor config (<l1size> <l2size> <hist_size> <xor> <frmt>) */
static int twolev_nelt = 5;
static int twolev_config[5] =
  { /* l1size */1, /* l2size */1024, /* hist */8, /* xor */FALSE, /* frmt */FALSE};
...
"  Predictor `comb' combines a bimodal and a 2-level predictor.\n"
  ...
  opt_reg_int_list(odb, "-bpred:bimod",
		   "bimodal predictor config (<table size> <frmt>)",
  ...
  opt_reg_int_list(odb, "-bpred:2lev",
		   ...
		   "(<l1size> <l2size> <hist_size> <xor> <frmt>)",
  ...
  opt_reg_int_list(odb, "-bpred:tscl",
                   "TAGE-SC-L (TSCL) predictor config "
		   "(<l1size> <budget> <m_depth> <alpha> <frmt>)",
                   twolev_config, twolev_nelt, &twolev_nelt,
		   /* default */twolev_config,
                   /* print */TRUE, /* format */NULL, /* !accrue */FALSE);
  
  opt_reg_int_list(odb, "-bpred:llbp",
                   "Last-Level (LLBP) predictor config "
		   "(<l1size> <budget> <m_depth> <alpha> <frmt>)",
                   twolev_config, twolev_nelt, &twolev_nelt,
		   /* default */twolev_config,
                   /* print */TRUE, /* format */NULL, /* !accrue */FALSE);
		  ...
		  int argc, char **argv)        /* command line arguments */
{
  ...
  if (!mystricmp(pred_type, "perfect"))
  ...
  else if (!mystricmp(pred_type, "bimod"))
    {
      ...
      if (bimod_nelt != 2)
	fatal("bad bimod predictor config (<table_size> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");
      ...
      pred = bpred_create(BPred2bit,
			  ...
			  /* FWD-REV Map Caches */bimod_config[1]);
    }
  else if (!mystricmp(pred_type, "2lev"))
    {
      /* 2-level adaptive predictor, bpred_create() checks args */
      if (twolev_nelt != 5)
	fatal("bad 2-level pred config (<l1size> <l2size> <hist_size> <xor> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");
      ...
      pred = bpred_create(BPred2Level,
			  ...
			  /* btb assoc */btb_config[1],
			  /* ret-addr stack size */ras_size,
			  /* FWD-REV Map Caches */twolev_config[4]);
    }
  ...
  else if (!mystricmp(pred_type, "oht"))
    {
      ...
      if (twolev_nelt != 5)
	fatal("bad OHT pred config (<l1size> <l2size> <hist_size> <xor> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");
  ...
  else if (!mystricmp(pred_type, "ob"))
    {
      /* outcome history table branch predictor, bpred_create() checks args */
      if (twolev_nelt != 5)
	fatal("bad OB pred config (<l1size> <l2size> <hist_size> <xor> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");
  ...
  else if (!mystricmp(pred_type, "mbp"))
    {
      /* outcome history table branch predictor, bpred_create() checks args */
      if (twolev_nelt != 5)
	fatal("bad MBP pred config (<l1size> <l2size> <hist_size> <xor> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");
  ...
  else if (!mystricmp(pred_type, "tscl"))
    {
      /* outcome history table branch predictor, bpred_create() checks args */
      if (twolev_nelt != 5)
	fatal("bad TSCL pred config (<l1size> <budget> <m_depth> <alpha> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");

      pred = bpred_create(BPredTSCL,
			  /* bimod table size */twolev_config[1],
			  /* 2lev l1 size */twolev_config[0],
			  /* 2lev l2 size */twolev_config[1],
			  /* meta table size */0,
			  /* history reg size */twolev_config[2],
  ...
  else if (!mystricmp(pred_type, "llbp"))
    {
      /* outcome history table branch predictor, bpred_create() checks args */
      if (twolev_nelt != 5)
	fatal("bad LLBP pred config (<l1size> <budget> <m_depth> <alpha> <frmt>)");
      if (btb_nelt != 2)
	fatal("bad btb config (<num_sets> <associativity>)");

      pred = bpred_create(BPredLLBP,
			  /* bimod table size */twolev_config[1],
			  /* 2lev l1 size */twolev_config[0],
			  /* 2lev l2 size */twolev_config[1],
			  /* meta table size */0,
