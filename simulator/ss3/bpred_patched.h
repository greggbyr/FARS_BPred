...
struct bpred_t {
  ...
  /* instrumentation counters for reversible mechanisms */
  counter_t ob_lookups;
  counter_t ob_hits;
  counter_t fhb_lookups;
  counter_t fhb_hits;
  counter_t oht_lookups;
  counter_t oht_hits;
  counter_t frmt_lookups;
  counter_t frmt_hits;
  counter_t frmt_misses;
  counter_t tage_lookups;
  counter_t tage_tag_matches;
  counter_t tage_sc_lookups;
  counter_t tage_sc_inversions;
  counter_t loop_lookups;
  counter_t loop_hits;
  counter_t llbp_lookups;
  counter_t llbp_hits;
};
